...
<s:form method="post" namespace="/" action="MailAction!save" id="form1" 
	...
	<table class= "table table-bordered" width="100%" border="1" style="font-size:12px;">
		<tr>
			...
			<td><s:textfield class="form-control selectpicker" style="width:30%" name="mailTitle" value = "%{ mailTitle }" />
		...
		<tr>
			<td>收件人</td>
			<td>
				<s:textfield class="form-control selectpicker" style="width:30%" name="receiverName_temp" disabled="true" value="%{ receiverName}"  ></s:textfield>
				<s:hidden name = "receiverName" value = "%{ receiverName }" /> <s:hidden name = "receiverId" value = "%{ receiverId }" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>原公告附件1</td>
			<td>
				<s:property value="filename1" />
			</td>
		</tr>
		<tr>
			<td>原公告附件2</td>
			<td>
				<s:property value="filename2" />
			</td>
		</tr>	
		<tr>
			<td>原公告附件3</td>
			<td>
				<s:property value="filename3" />
			</td>
		</tr>		
		<tr>
			<td>新公告附件</td>
