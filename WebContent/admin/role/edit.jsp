...
<html>
<head>
<script src="<%=path %>/jquery_validation_1.16.0/lib/jquery-3.1.1.js" type="text/javascript"></script> 
...
<body>
	<s:form id="Myform" namespace="/" action="RoleAction!modify" method="post">
		<table class= "table table-bordered">
			<tr>
				<td>角色编码</td>
				<td><s:textfield class="form-control selectpicker" style="width:30%" name="roleid_temp" disabled="true" value="%{roleId}" /> 
					<s:hidden name="roleId" />
				  </td>
			</tr>
			<tr>
				<td>角色名</td>
				<td><s:textfield class="form-control selectpicker" style="width:30%" name="roleName" />  </td>
			</tr>
			<tr>
				<td>备注</td>
				<td><s:textarea class="form-control selectpicker" style="width:100%" name="roleRemark" cols="50" rows="5" />    </td>
			</tr>
			<tr>
				<td>角色权限</td>
				<td>
			...
			<tr>
			<td colspan="2">
				<Input class="btn btn-primary" type="button" value="保存数据" onclick="saveData();"/>
