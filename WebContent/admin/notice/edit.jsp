...
<body onload="init();">
<s:form method="post" namespace="/" action="NoticeAction!modify" id="form1" 
	...
	<table class= "table table-bordered" width="100%" border="1" style="font-size:12px;">
		...
		<tr>
			<td>添加人员</td>
			<td><s:textfield class="form-control selectpicker" style="width:30%" name="noticeAdduser_temp" disabled="true" value="%{noticeAdduser}" /> 
				<s:hidden name ="noticeAdduser"  /></td>
		</tr>
		<tr>
			<td>添加时间</td>
		...
		<tr>
			<td>公告新附件</td>
			<td><s:file class = "btn btn-default" name="attch" size="40" value="#attch" /></td>
		</tr>		
		<tr>
			<td colspan="2">
