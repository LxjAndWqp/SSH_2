...
<body>
	<s:form  method="post" namespace="/" action="DataAction!save" id="Myform">
		<table class= "table table-bordered">
			<tr>
				<td align="right"><span class="glyphicon glyphicon-asterisk text-danger"></span>数据名称:</td>
				<td><s:textfield class="form-control selectpicker" style="width:30%" name="dataName"  /></td>
			</tr>
			<tr>
				<td align="right"><span class="glyphicon glyphicon-asterisk text-danger"></span>数据类型:</td>
				<td>
			...
			<tr>
				<td align="right"><span class="glyphicon glyphicon-asterisk text-danger"></span>数据长度:</td>
				<td><s:textfield class="form-control selectpicker" style="width:30%" name="dataLength" /></td>
			</tr>
			<tr>
				<td align="right"><span class="glyphicon glyphicon-asterisk text-danger"></span>是否空值:</td>
				<td>
					<s:radio list="#{'1':'是','0':'否'}" name="isEmpty" value="1"/>
				</td>
			</tr>
			<tr>
				<td align="right"><span class="glyphicon glyphicon-asterisk text-danger"></span>是否有范围:</td>
				<td>
