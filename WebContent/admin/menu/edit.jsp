...
<body>
	<s:form  method="post" namespace="/" action="MenuAction!modify" id="Myform">
		<table class= "table table-bordered">
			<tr>
				<td align="right">菜单编码</td>
				<td><s:textfield class="form-control selectpicker" style="width:30%" name="menu_id_temp"  value = "%{menuId}" disabled="true" />
